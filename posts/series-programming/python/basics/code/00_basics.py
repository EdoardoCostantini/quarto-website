...
tweets_df = pd.read_csv("./posts/series-programming/python/basics/data/tweets.csv")
...
# Define a function to count the number of entries in a column of a DataFrame
...
# Use the function
count_entries(df = tweets_df, col_name="lang")
