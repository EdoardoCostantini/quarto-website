...
@littleRubin:2002 [p148] defined it as follows:
...
If you are interested in the mathematical details, I recommend reading the full sweep operator description in @goodnight:1979 [p154], @schafer:1997, or @littleRubin:2002 [p148].

@goodnight:1979 [p150] is a particularly helpful paper as it describes an easy implementation of the sweep operator.
...
Let's start by coding a simple function that performs the operations described by @goodnight:1979 [p150].
...
To understand how the sweep operator relates to the estimation of multivariate linear models, we will work with a data set used by @littleRubin:2002 [p152].
