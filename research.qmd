...
List of things I worked on or am still working on.
...
yaml_data = yaml.safe_load(open("research.yaml"))
pub_strs = {"pubs": {}, "wps": {}}
for _, data in yaml_data.items():
    title_str = data["title"]
    authors = data.get("authors", ["me"])
    authors = [aut if aut != "me" else "<strong>Edoardo Costantini</strong>" for aut in authors]
    ...
    if dataset is not None:
        buttons.append(button(dataset, "dataset", "bi-clipboard-data"))
    shiny = data.get("shiny")
    if shiny is not None:
        buttons.append(button(shiny, "shiny", "bi-graph-up"))
